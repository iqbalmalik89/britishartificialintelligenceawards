...
return array(
	...
	// Content Description
	'content_description' => sprintf( __( 'Add or edit content template on the %s page', 'us' ), '<a href="' . admin_url() . 'edit.php?post_type=us_page_block" target="_blank" rel="noopener">' . __( 'Page Blocks', 'us' ) . '</a>' ),

...
/*
 * Dev note: We have added code for Exclude Rows Menu feature, see line #930. Add this code on class update
 */
...
<?php endif; ?>
	...
	<p class="submit"><input type="submit" class="button" value="<?php echo 'Submit'; ?>" /></p>
</form>
<?php
	}

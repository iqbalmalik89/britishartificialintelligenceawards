...
function us_get_used_in_locations( $post_ID, $show_no_results = FALSE ) {
	...
	$usage_query = "SELECT `option_name`, `option_value` FROM {$wpdb->options} WHERE option_name LIKE 'widget%'AND option_value REGEXP '\"layout\";s:" . iconv_strlen( $post_ID ) . ":\"" . $post_ID . "\"' LIMIT 0, 100";

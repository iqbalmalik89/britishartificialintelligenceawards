...
function usgb_edit_form_top( $post ) {
	...
	echo '<div class="usof-control for_help"><a href="https://help.us-themes.com/' . strtolower( US_THEMENAME ) . '/grid/" target="_blank" rel="noopener" title="' . us_translate( 'Help' ) . '"></a></div>';

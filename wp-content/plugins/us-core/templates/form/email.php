...
?>
<div class="w-form-row for_email<?php echo $classes ?>">
	<?php if ( ! empty( $label ) ) : ?>
	...
	<?php endif; ?>
	<div class="w-form-row-state"><?php echo us_translate( 'Please enter a valid email address.' ) ?></div>
</div>

...
<div class="us-bld-window for_editing">
	<div class="us-bld-window-h">
		...
		<div class="us-bld-window-footer">
			<div class="us-bld-window-btn for_close"><span><?php echo us_translate( 'Close' ) ?></span></div>
			<div class="us-bld-window-btn for_save"><span><?php echo us_translate( 'Save Changes' ) ?></span></div>
		</div>
	</div>
</div>

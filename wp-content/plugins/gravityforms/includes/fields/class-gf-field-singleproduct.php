...
class GF_Field_SingleProduct extends GF_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		return "<div class='ginput_container ginput_container_singleproduct'>
					...
					<div class=\"pricing-field\"><span class='ginput_product_price_label'>" . gf_apply_filters( array( 'gform_product_price', $form_id, $this->id ), esc_html__( 'Price', 'gravityforms' ), $form_id ) . ":</span> <span class='ginput_product_price' id='{$field_id}'>" . esc_html( GFCommon::to_money( $price, $currency ) ) . "</span></div>
					...
					<div class=\"pricing-field-xp\">
					<a href='/venue/' target='_blank' class='btn'><i class='fa fa-info'></i></a>
					<a href='/terms-and-conditions/' target='_blank' class='btn'><i class='far fa-copy'></i></a>
					<a href='/contact-us/' target='_blank' class='btn'><i class='fa fa-question'></i></a>
					</div>
				</div>";
	}

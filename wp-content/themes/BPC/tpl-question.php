...
#section4-container{background:#090909;position:relative;overflow:hidden;color:#CA974D;margin-top:30px;padding-top:50px;min-height:470px;margin-bottom:0px;}
...
a.number-option {margin-right: 25px;}
...
.question-header{color:#CA974D;text-align:center;font-size:23px;line-height:30px;font-weight: 500;margin-top:40px;margin-bottom:72px;}
</style>
<div class="l-main">
            ...
            <section id="section4-container" class="clear fill-browser">
                <div id="section4-inner" class="container wrap fill-browser-inner hide-on-mobile">
                    ...
                    <div id="question-6-1" class="question-container fill-browser-inner-section4">
                        ...
                        <div class="section4-input-container">
							<textarea type="text" id="sfb-improve-web" class="section4-text-input wpcf7-text textarea-box validation-required" data-validation="text" name="improve" title="How would you improve this website?" data-target="#s4-improve-web"></textarea>
                        </div>
                        <div class="section4-selections"><br>
                            <div class="button-container not-under-paragraph">
                                <a href="#enter" class="selection-option long-button validation-required" data-target="#sfb-improve-web" data-validation="text">Enter</a>
                            </div>
                        </div>
                    </div>
                    <div id="question-6-2" class="question-container fill-browser-inner-section4">
                        ...
                        <div class="section4-selections"><br>
                            <div class="button-container not-under-paragraph">
								<a href="#enter" class="selection-option long-button validation-required" data-target="#sfb-take-as-many-days-off" data-validation="text">Enter</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="question-7-1" class="question-container fill-browser-inner-section4">
                        ...
                        <div class="section4-input-container">
                            <input type="text" id="sfb-word-cat" class="section4-text-input wpcf7-text validation-required" data-validation="text" name="word-cat" title="How many letters are there in the word cat?" data-target="#s4-word-cat" />
                        </div>
                        <div class="section4-selections"><br>
                            <div class="button-container not-under-paragraph">
								<a href="#enter" class="selection-option long-button validation-required" data-target="#sfb-word-cat" data-validation="text">Enter</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="question-12" class="question-container fill-browser-inner-section4">
                        ...
                        <div class="section4-input-container">
                            <input type="text" id="sfb-plant_life_former_president" class="section4-text-input wpcf7-text validation-required" data-validation="text" name="plant_life_former_president" title="How many letters are there in the word cat?" data-target="#s4-plant_life_former_president" />
                        </div>
                        <div class="section4-selections"><br>
                            <div class="button-container not-under-paragraph">
								<a href="#enter" class="selection-option long-button validation-required" data-target="#sfb-plant_life_former_president" data-validation="text">Enter</a>
                            </div>
                        </div>
                    </div>
